var camelCase, getBestValidResponse, getQueryParams, getUriParameter, mapRequestResponse, parseForm, util, utilMapProperty, utilSchemas, _;
...
util.parseResource = function(resource, options, schemas, customAdapter, parentUri, parentUriArgs) {
  var classType, innerResource, m, methodDef, parsed, request, respond, responseType, uriArgs, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
...
parseForm = function(body, annotations, mapping) {
  ...
  if (form) {
    ...
    for (key in data) {
      ...
      if (parsedProperty.classType === "InputStream") {
        args.push({
          name: parsedProperty.name + "Data",
          classType: "FormDataContentDisposition",
